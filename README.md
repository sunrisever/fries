...
- Current app version: `0.4.8-beta`
- Product name: `Fries / 薯条`
- Default Windows installer artifact: `Fries-Setup-0.4.8-beta-x64.exe`
- Default Windows portable artifact: `Fries-Portable-0.4.8-beta-x64.exe`
